...
| CB2, CB3 | 1µF (rivisto da 22µF in Task 5, verifica SPICE) | 1206 (1210 ammesso se necessario) | `Module("@stdlib/generics/Capacitor.zen")` — `value="1uF"`, `package="1206"`, `dielectric="X7R"`, `voltage="50V"` | 1206 | — (generic) | X7R 50V 1µF in 1206 e' un valore molto comune, nessun problema di reperibilita'; valore ridotto rispetto alla bozza Task 3 per spostare il ginocchio passa-alto dell'uscita bilanciata da <1Hz a ~30Hz (vedi `docs/sim-results.md`) |
