...
| J1 | XLR (pad sandwich NC3MXX) | footprint custom `./footprints/J1_NC3MXX_Sandwich.kicad_mod` | `Component()` primitivo, `skip_bom=True` | n/a | 1.5kVdc (rating connettore Neutrik) | Nessuna parte da ordinare a parte: sono pad del PCB stesso (pin1/2 su F.Cu, pin3 su B.Cu, passo 7.62mm) che si saldano direttamente ai bicchierini del connettore Neutrik NC3MXX/NC3MXX-EMC |
